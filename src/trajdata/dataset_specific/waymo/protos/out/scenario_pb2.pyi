import camera_tokens_pb2 as _camera_tokens_pb2
import compressed_lidar_pb2 as _compressed_lidar_pb2
...
class Scenario(_message.Message):
    __slots__ = ('scenario_id', 'timestamps_seconds', 'current_time_index', 'tracks', 'dynamic_map_states', 'map_features', 'sdc_track_index', 'objects_of_interest', 'tracks_to_predict', 'compressed_frame_laser_data', 'frame_camera_tokens')
